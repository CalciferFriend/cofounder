...
Or edit `~/.tom-and-jerry/peers/jerry-beast.json` directly:
...
# → Removes ~/.tom-and-jerry/peers/jerry-beast.json
...
```bash
echo "[]" > ~/.tom-and-jerry/context/jerry-home.json
```
